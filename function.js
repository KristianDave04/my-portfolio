    ...
    case 'hobbies':
      content = `
        ...
        <div class="card-grid">
          ...
          <div class="card"><img src="../portfolio copy/assets/fav books/sherlock.jpg" alt="Hobby 3"><p>At my free time, I enjoy reading books</p></div>
          <div class="card"><img src="../portfolio copy/assets/hobbies/digital.png" alt="Hobby 3"><p>I love drawing some digital art</p></div>
        </div>
      `;
      break;
